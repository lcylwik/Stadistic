...
<p style='font-size:2px'>&nbsp</p>
            ...
            <?php   
                    ...
                    for ($i = 0; $i < $tabla_promedios_count; $i++ ){
                    	...
                    	$MIN_MAX[$i][1] = $tabla_promedios[$i][1] - ($tabla_promedios[$i][2] * $alfa);
                    	$MIN_MAX[$i][2] = $tabla_promedios[$i][1] + ($tabla_promedios[$i][2] * $alfa);
                    	if ($MIN_MAX[$i][1] < 0 ) {
                    		$MIN_MAX[$i][1] = 0; 
                    	}
                    }
...
//*******************************************************************************************************************************************
                    for ($codigo_count=0;$codigo_count < $tabla_count;$codigo_count++) {
                        ...
                        $max = 0;
                        echo "<TR align='right' bgcolor=$color>";
                        echo "<td nowrap='nowrap' align='left' style='background-color:\"#072B8A\"; color:\"#FFFFFF\"'> <input type=checkbox id='" . $tabla_cruzada[$codigo_count][0] . "' name='selected7[]' $chk_s7 value='" . $tabla_cruzada[$codigo_count][0] . "' title='" . $tabla_cruzada[$codigo_count][0] . "' alt='Select (" . $tabla_cruzada[$codigo_count][0] . ")' accept='" . $tabla_cruzada[$codigo_count][0] . "'><a>" . $tabla_cruzada[$codigo_count][0] . "</a></td>";
                        ...
                        echo "<td bgcolor=#B8B8B8>" . number_format($min,2,'.',',') . "</td>";
                        echo "<td bgcolor=#B8B8B8>" . number_format($max,2,'.',',') . "</td>";
                        echo "</TR>\n";
                    }
