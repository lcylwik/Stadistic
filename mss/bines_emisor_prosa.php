...
//                    echo "</td>";
                    ...
                    if ($QRY_WHERE == null) {
                        ...
                        $QRY_WHERE = "WHERE BIN IN (SELECT SUBSTR(BIN,0,6) FROM BINES_EMISOR_PROSA) AND TIPO NOT IN ('0320')";
                    } else {
                        $QRY_WHERE = "WHERE " . substr($QRY_WHERE, 4) . " AND BIN IN (SELECT SUBSTR(BIN,0,6) FROM BINES_EMISOR_PROSA) AND TIPO NOT IN ('0320')";
                    }
                    echo "</td>";
            ?>
                      </tr>
            				...
            				<td align='center' valign='bottom' width='400px' ><a title='Vista enfocada a los Bines. Aqui se puede ver el listado de Bines y sus totales de transacciones en el mes' style='font-size:200%;'> Emisor PROSA </a></td>
