        ...
        <script LANGUAGE="JavaScript" type="text/javascript">
            ...
            function ocultaSinFiltros(){
                ...
                if(checaActivos('selected3[]') == 1)
                    document.getElementById('tipoIsoHide').style.display='none';
              
                if(checaActivos('selected13[]') == 1)
                    document.getElementById('tipoB24Hide').style.display='none';
                ...
                if(checaActivos('selected14[]') == 1)
                    document.getElementById('origProcHide').style.display='none';

                if(checaActivos('selected15[]') == 1)
                    document.getElementById('destProcHide').style.display='none';

                if(checaActivos('selected16[]') == 1)
                    document.getElementById('respIsoHide').style.display='none';

                if(checaActivos('selected7[]') == 1)
                    document.getElementById('respB24Hide').style.display='none';
            }
            ...
            function muestraTodo(){
                ...
                document.getElementById('tipoIsoHide').style.display='inline';
                document.getElementById('tipoB24Hide').style.display='inline';
                ...
                document.getElementById('origProcHide').style.display='inline';
                document.getElementById('destProcHide').style.display='inline';
                document.getElementById('respIsoHide').style.display='inline';
                document.getElementById('respB24Hide').style.display='inline';
            }
...
//                    echo "</td>";
                                ...
                                if (!empty($_POST['selected7'])) {
                                    foreach ($_POST['selected7'] as $cajita7) {
                                        $QRY_RESP_B24 = $QRY_RESP_B24 . ",'" . substr($cajita7, 0, 3) . "'";
                                    }
                                    $chk_s7 = 'checked';
                                }
                                if ($QRY_RESP_B24 == null) {

                                    $QRY_WHERE = $QRY_WHERE;
                                } else {
                                    $QRY_WHERE = $QRY_WHERE . " AND RESP_B24 IN (" . substr($QRY_RESP_B24, 1) . ")";
                                }

                                
                                
                                
                                if (!empty($_POST['selected16'])) {
                                    foreach ($_POST['selected16'] as $cajita16) {
                                        $QRY_RESP_ISO = $QRY_RESP_ISO . ",'" . $cajita16 . "'";
                                    }
                                    $chk_s16 = 'checked';
                                }
                                if ($QRY_RESP_ISO == null) {

                                    $QRY_WHERE = $QRY_WHERE;
                                } else {
                                    $QRY_WHERE = $QRY_WHERE . " AND RESP_ISO IN (" . substr($QRY_RESP_ISO, 1) . ")";
                                }
                                ...
                                if (!empty($_POST['selected3'])) {
                                    foreach ($_POST['selected3'] as $cajita3) {
                                        $QRY_TIPO_ISO = $QRY_TIPO_ISO . ",'" . $cajita3 . "'";
                                    }
                                    $chk_s3 = 'checked';
                                }
                                if ($QRY_TIPO_ISO == null) {

                                    $QRY_WHERE = $QRY_WHERE;
                                } else {
                                    $QRY_WHERE = $QRY_WHERE . " AND TIPO_ISO IN (" . substr($QRY_TIPO_ISO, 1) . ")";
                                }
                                ...
                                if (!empty($_POST['selected13'])) {
                                    foreach ($_POST['selected13'] as $cajita13) {
                                        $QRY_TIPO_B24 = $QRY_TIPO_B24 . ",'" . $cajita13 . "'";
                                    }
                                    $chk_s13 = 'checked';
                                }
                                if ($QRY_TIPO_B24 == null) {
                                    $QRY_WHERE = $QRY_WHERE;
                                } else {
                                    $QRY_WHERE = $QRY_WHERE . " AND TIPO_B24 IN (" . substr($QRY_TIPO_B24, 1) . ")";
                                }
                                ...
                                if (!empty($_POST['selected14'])) {
                                    foreach ($_POST['selected14'] as $cajita14) {
                                        $QRY_ORIG_PROC = $QRY_ORIG_PROC . ",'" . $cajita14 . "'";
                                    }
                                    $chk_s14 = 'checked';
                                }
                                if ($QRY_ORIG_PROC == null) {

                                    $QRY_WHERE = $QRY_WHERE;
                                } else {
                                    $QRY_WHERE = $QRY_WHERE . " AND ORIG_PROC IN (" . substr($QRY_ORIG_PROC, 1) . ")";
                                }
                    ...
                    <td align='center'>
                        ...
                        <div id="ddtopmenubar" class="chromemenu">
                            <ul>
                                ...
                                <li><a onclick='oculta("tipoIsoHide")' style="cursor:hand">Mensaje Iso</a></li>
                                <li><a onclick='oculta("tipoB24Hide")' style="cursor:hand">Mensaje B24</a></li>
                                ...
                                <li><a onclick='oculta("origProcHide")' style="cursor:hand">Origen</a></li>
                                <li><a onclick='oculta("destProcHide")' style="cursor:hand">Destino</a></li>
                                <li><a onclick='oculta("respIsoHide")' style="cursor:hand">Cod Resp Iso</a></li>
                                <li><a onclick='oculta("respB24Hide")' style="cursor:hand">Cod Resp B24</a></li>
                            </ul>
                        </div>
